		...
		\begin{tabular}{|p{3cm}|p{5cm}|p{5cm}|p{5cm}|}
			...
			Heeft volgende opties:
				& De ingebouwde functies zijn volgende:
					...
					\end{itemize} 
				&  \\ \hline
				& Bij het inloggen wordt een c'ie aangemaakt die dan wordt opgeslaan in de API gateway. \\ \hline
			Voordelen 
...
\begin{table}[]
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|p{2cm}|p{5cm}|p{5cm}|p{5cm}|}
			...
			Voordelen
				& Er is geen nood aan c'ies, session ID's, login pagina's, ' een handshake bevestigen is niet nodig.
